...
public class EndRaceMenuController : MonoBehaviour
{
    ...
    // --- CRUCIAL: Esto activa la lógica cada frame ---
    private void Update()
    {
    ...
    // --- CRUCIAL: Esto reinicia la selección cuando el panel aparece ---
    ...
    {
        // Cambia BUTTONS.B por el botón que uses para confirmar (ej. A o Start)

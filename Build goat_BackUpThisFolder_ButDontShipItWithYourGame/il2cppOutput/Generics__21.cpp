...
IL_0035:
	{
		...
		V_1 = L_10;
		int32_t L_11 = V_1;
		Dictionary_2_Resize_m09FA7BEF91F1E5AA52E3662F3569C6C27B40A437(__this, L_11, (bool)0, il2cpp_rgctx_method(method->klass->rgctx_data, 46));
		int32_t L_12 = V_1;
		return L_12;
	}
}
...
IL_0009:
	...
	try
	{
		...
		try
		{
			int32_t L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_mAE0A06EC5B926430F136A7C53C6C039591152462(__this, L_3, ((*(int32_t*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 17)))), il2cpp_rgctx_method(method->klass->rgctx_data, 51));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
